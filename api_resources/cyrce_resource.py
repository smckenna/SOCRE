...
class CyrceResource(Resource):
    ...
    def json_to_input(self, json_data, control_mode='csf'):
        ...
        if control_mode == 'csf':
            ...
            csf = None
            ac = AC(value=json_data['sp80053']['AC'],
                    AC_1=json_data['sp80053']['AC']['AC-1'],
                    AC_2=json_data['sp80053']['AC']['AC-2'],
                    AC_3=json_data['sp80053']['AC']['AC-3'],
                    AC_4=json_data['sp80053']['AC']['AC-4'],
                    AC_5=json_data['sp80053']['AC']['AC-5'],
                    AC_6=json_data['sp80053']['AC']['AC-6'],
                    AC_7=json_data['sp80053']['AC']['AC-7'],
                    AC_8=json_data['sp80053']['AC']['AC-8'],
                    AC_10=json_data['sp80053']['AC']['AC-10'],
                    AC_11=json_data['sp80053']['AC']['AC-11'],
                    AC_12=json_data['sp80053']['AC']['AC-12'],
                    AC_14=json_data['sp80053']['AC']['AC-14'],
                    AC_17=json_data['sp80053']['AC']['AC-17'],
                    AC_18=json_data['sp80053']['AC']['AC-18'],
                    AC_19=json_data['sp80053']['AC']['AC-19'],
                    AC_20=json_data['sp80053']['AC']['AC-20'],
                    AC_21=json_data['sp80053']['AC']['AC-21'],
                    AC_22=json_data['sp80053']['AC']['AC-22'])
            at = AT(value=json_data['sp80053']['AT'],
                    AT_1=json_data['sp80053']['AT']['AT-1'],
                    AT_2=json_data['sp80053']['AT']['AT-2'],
                    AT_3=json_data['sp80053']['AT']['AT-3'],
                    AT_4=json_data['sp80053']['AT']['AT-4'])
            au = AU(value=json_data['sp80053']['AU'],
                    AU_1=json_data['sp80053']['AU']['AU-1'],
                    AU_2=json_data['sp80053']['AU']['AU-2'],
                    AU_3=json_data['sp80053']['AU']['AU-3'],
                    AU_4=json_data['sp80053']['AU']['AU-4'],
                    AU_5=json_data['sp80053']['AU']['AU-5'],
                    AU_6=json_data['sp80053']['AU']['AU-6'],
                    AU_7=json_data['sp80053']['AU']['AU-7'],
                    AU_8=json_data['sp80053']['AU']['AU-8'],
                    AU_9=json_data['sp80053']['AU']['AU-9'],
                    AU_10=json_data['sp80053']['AU']['AU-10'],
                    AU_11=json_data['sp80053']['AU']['AU-11'],
                    AU_12=json_data['sp80053']['AU']['AU-12'])
            ca = CA(value=json_data['sp80053']['CA'],
                    CA_1=json_data['sp80053']['CA']['CA-1'],
                    CA_2=json_data['sp80053']['CA']['CA-2'],
                    CA_3=json_data['sp80053']['CA']['CA-3'],
                    CA_5=json_data['sp80053']['CA']['CA-5'],
                    CA_6=json_data['sp80053']['CA']['CA-6'],
                    CA_7=json_data['sp80053']['CA']['CA-7'],
                    CA_8=json_data['sp80053']['CA']['CA-8'],
                    CA_9=json_data['sp80053']['CA']['CA-9'])
            cm = CM(value=json_data['sp80053']['CM'],
                    CM_1=json_data['sp80053']['CM']['CM-1'],
                    CM_2=json_data['sp80053']['CM']['CM-2'],
                    CM_3=json_data['sp80053']['CM']['CM-3'],
                    CM_4=json_data['sp80053']['CM']['CM-4'],
                    CM_5=json_data['sp80053']['CM']['CM-5'],
                    CM_6=json_data['sp80053']['CM']['CM-6'],
                    CM_7=json_data['sp80053']['CM']['CM-7'],
                    CM_8=json_data['sp80053']['CM']['CM-8'],
                    CM_9=json_data['sp80053']['CM']['CM-9'],
                    CM_10=json_data['sp80053']['CM']['CM-10'],
                    CM_11=json_data['sp80053']['CM']['CM-11'],
                    CM_12=json_data['sp80053']['CM']['CM-12'])
            cp = CP(value=json_data['sp80053']['CP'],
                    CP_1=json_data['sp80053']['CP']['CP-1'],
                    CP_2=json_data['sp80053']['CP']['CP-2'],
                    CP_3=json_data['sp80053']['CP']['CP-3'],
                    CP_4=json_data['sp80053']['CP']['CP-4'],
                    CP_6=json_data['sp80053']['CP']['CP-6'],
                    CP_7=json_data['sp80053']['CP']['CP-7'],
                    CP_8=json_data['sp80053']['CP']['CP-8'],
                    CP_9=json_data['sp80053']['CP']['CP-9'],
                    CP_10=json_data['sp80053']['CP']['CP-10'])
            ia = IA(value=json_data['sp80053']['IA'],
                    IA_1=json_data['sp80053']['IA']['IA-1'],
                    IA_2=json_data['sp80053']['IA']['IA-2'],
                    IA_3=json_data['sp80053']['IA']['IA-3'],
                    IA_4=json_data['sp80053']['IA']['IA-4'],
                    IA_5=json_data['sp80053']['IA']['IA-5'],
                    IA_6=json_data['sp80053']['IA']['IA-6'],
                    IA_7=json_data['sp80053']['IA']['IA-7'],
                    IA_8=json_data['sp80053']['IA']['IA-8'],
                    IA_11=json_data['sp80053']['IA']['IA-11'],
                    IA_12=json_data['sp80053']['IA']['IA-12'])
            ir = IR(value=json_data['sp80053']['IR'],
                    IR_1=json_data['sp80053']['IR']['IR-1'],
                    IR_2=json_data['sp80053']['IR']['IR-2'],
                    IR_3=json_data['sp80053']['IR']['IR-3'],
                    IR_4=json_data['sp80053']['IR']['IR-4'],
                    IR_5=json_data['sp80053']['IR']['IR-5'],
                    IR_6=json_data['sp80053']['IR']['IR-6'],
                    IR_7=json_data['sp80053']['IR']['IR-7'],
                    IR_8=json_data['sp80053']['IR']['IR-8'])
            ma = MA(value=json_data['sp80053']['MA'],
                    MA_1=json_data['sp80053']['MA']['MA-1'],
                    MA_2=json_data['sp80053']['MA']['MA-2'],
                    MA_3=json_data['sp80053']['MA']['MA-3'],
                    MA_4=json_data['sp80053']['MA']['MA-4'],
                    MA_5=json_data['sp80053']['MA']['MA-5'],
                    MA_6=json_data['sp80053']['MA']['MA-6'])
            mp = MP(value=json_data['sp80053']['MP'],
                    MP_1=json_data['sp80053']['MP']['MP-1'],
                    MP_2=json_data['sp80053']['MP']['MP-2'],
                    MP_3=json_data['sp80053']['MP']['MP-3'],
                    MP_4=json_data['sp80053']['MP']['MP-4'],
                    MP_5=json_data['sp80053']['MP']['MP-5'],
                    MP_6=json_data['sp80053']['MP']['MP-6'],
                    MP_7=json_data['sp80053']['MP']['MP-7'])
            pe = PE(value=json_data['sp80053']['PE'],
                    PE_1=json_data['sp80053']['PE']['PE-1'],
                    PE_2=json_data['sp80053']['PE']['PE-2'],
                    PE_3=json_data['sp80053']['PE']['PE-3'],
                    PE_4=json_data['sp80053']['PE']['PE-4'],
                    PE_5=json_data['sp80053']['PE']['PE-5'],
                    PE_6=json_data['sp80053']['PE']['PE-6'],
                    PE_8=json_data['sp80053']['PE']['PE-8'],
                    PE_9=json_data['sp80053']['PE']['PE-9'],
                    PE_10=json_data['sp80053']['PE']['PE-10'],
                    PE_11=json_data['sp80053']['PE']['PE-11'],
                    PE_12=json_data['sp80053']['PE']['PE-12'],
                    PE_13=json_data['sp80053']['PE']['PE-13'],
                    PE_14=json_data['sp80053']['PE']['PE-14'],
                    PE_15=json_data['sp80053']['PE']['PE-15'],
                    PE_16=json_data['sp80053']['PE']['PE-16'],
                    PE_17=json_data['sp80053']['PE']['PE-17'],
                    PE_18=json_data['sp80053']['PE']['PE-18'])
            pl = PL(value=json_data['sp80053']['PL'],
                    PL_1=json_data['sp80053']['PL']['PL-1'],
                    PL_2=json_data['sp80053']['PL']['PL-2'],
                    PL_4=json_data['sp80053']['PL']['PL-4'],
                    PL_8=json_data['sp80053']['PL']['PL-8'],
                    PL_10=json_data['sp80053']['PL']['PL-10'],
                    PL_11=json_data['sp80053']['PL']['PL-11'])
            ps = PS(value=json_data['sp80053']['PS'],
                    PS_1=json_data['sp80053']['PS']['PS-1'],
                    PS_2=json_data['sp80053']['PS']['PS-2'],
                    PS_3=json_data['sp80053']['PS']['PS-3'],
                    PS_4=json_data['sp80053']['PS']['PS-4'],
                    PS_5=json_data['sp80053']['PS']['PS-5'],
                    PS_6=json_data['sp80053']['PS']['PS-6'],
                    PS_7=json_data['sp80053']['PS']['PS-7'],
                    PS_8=json_data['sp80053']['PS']['PS-8'],
                    PS_9=json_data['sp80053']['PS']['PS-9'])
            ra = RA(value=json_data['sp80053']['RA'],
                    RA_1=json_data['sp80053']['RA']['RA-1'],
                    RA_2=json_data['sp80053']['RA']['RA-2'],
                    RA_3=json_data['sp80053']['RA']['RA-3'],
                    RA_5=json_data['sp80053']['RA']['RA-5'],
                    RA_7=json_data['sp80053']['RA']['RA-7'],
                    RA_9=json_data['sp80053']['RA']['RA-9'])
            sa = SA(value=json_data['sp80053']['SA'],
                    SA_1=json_data['sp80053']['SA']['SA-1'],
                    SA_2=json_data['sp80053']['SA']['SA-2'],
                    SA_3=json_data['sp80053']['SA']['SA-3'],
                    SA_4=json_data['sp80053']['SA']['SA-4'],
                    SA_5=json_data['sp80053']['SA']['SA-5'],
                    SA_8=json_data['sp80053']['SA']['SA-8'],
                    SA_9=json_data['sp80053']['SA']['SA-9'],
                    SA_10=json_data['sp80053']['SA']['SA-10'],
                    SA_11=json_data['sp80053']['SA']['SA-11'],
                    SA_15=json_data['sp80053']['SA']['SA-15'],
                    SA_16=json_data['sp80053']['SA']['SA-16'],
                    SA_17=json_data['sp80053']['SA']['SA-17'],
                    SA_21=json_data['sp80053']['SA']['SA-21'],
                    SA_22=json_data['sp80053']['SA']['SA-22'])
            sc = SC(value=json_data['sp80053']['SC'],
                    SC_1=json_data['sp80053']['SC']['SC-1'],
                    SC_2=json_data['sp80053']['SC']['SC-2'],
                    SC_3=json_data['sp80053']['SC']['SC-3'],
                    SC_4=json_data['sp80053']['SC']['SC-4'],
                    SC_5=json_data['sp80053']['SC']['SC-5'],
                    SC_7=json_data['sp80053']['SC']['SC-7'],
                    SC_8=json_data['sp80053']['SC']['SC-8'],
                    SC_10=json_data['sp80053']['SC']['SC-10'],
                    SC_12=json_data['sp80053']['SC']['SC-12'],
                    SC_13=json_data['sp80053']['SC']['SC-13'],
                    SC_15=json_data['sp80053']['SC']['SC-15'],
                    SC_17=json_data['sp80053']['SC']['SC-17'],
                    SC_18=json_data['sp80053']['SC']['SC-18'],
                    SC_20=json_data['sp80053']['SC']['SC-20'],
                    SC_21=json_data['sp80053']['SC']['SC-21'],
                    SC_22=json_data['sp80053']['SC']['SC-22'],
                    SC_23=json_data['sp80053']['SC']['SC-23'],
                    SC_24=json_data['sp80053']['SC']['SC-24'],
                    SC_28=json_data['sp80053']['SC']['SC-28'],
                    SC_39=json_data['sp80053']['SC']['SC-39'])
            si = SI(value=json_data['sp80053']['SI'],
                    SI_1=json_data['sp80053']['SI']['SI-1'],
                    SI_2=json_data['sp80053']['SI']['SI-2'],
                    SI_3=json_data['sp80053']['SI']['SI-3'],
                    SI_4=json_data['sp80053']['SI']['SI-4'],
                    SI_5=json_data['sp80053']['SI']['SI-5'],
                    SI_6=json_data['sp80053']['SI']['SI-6'],
                    SI_7=json_data['sp80053']['SI']['SI-7'],
                    SI_8=json_data['sp80053']['SI']['SI-8'],
                    SI_10=json_data['sp80053']['SI']['SI-10'],
                    SI_11=json_data['sp80053']['SI']['SI-11'],
                    SI_12=json_data['sp80053']['SI']['SI-12'],
                    SI_16=json_data['sp80053']['SI']['SI-16'])
            sr = SR(value=json_data['sp80053']['SR'],
                    SR_1=json_data['sp80053']['SR']['SR-1'],
                    SR_2=json_data['sp80053']['SR']['SR-2'],
                    SR_3=json_data['sp80053']['SR']['SR-3'],
                    SR_5=json_data['sp80053']['SR']['SR-5'],
                    SR_6=json_data['sp80053']['SR']['SR-6'],
                    SR_8=json_data['sp80053']['SR']['SR-8'],
                    SR_9=json_data['sp80053']['SR']['SR-9'],
                    SR_10=json_data['sp80053']['SR']['SR-10'],
                    SR_11=json_data['sp80053']['SR']['SR-11'],
                    SR_12=json_data['sp80053']['SR']['SR-12'])

            sp80053 = Sp80053(AC=ac, AT=at, AU=au, CA=ca, CM=cm, CP=cp, IA=ia, IR=ir, MA=ma, MP=mp, PE=pe, PL=pl, PS=ps,
