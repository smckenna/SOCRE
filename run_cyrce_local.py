...
if __name__ == '__main__':
    ...
    scenario = Scenario(attackAction='error', attackThreatType='insider', attackTarget='label:Crown Jewel',
    ...
    output_csf = run_cyrce(cyrce_input=cyrce_input, control_mode=control_mode, run_mode=['residual', 'residual'])
